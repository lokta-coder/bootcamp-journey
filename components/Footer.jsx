      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="flex flex-col gap-10 sm:flex-row sm:justify-between">
          <div className="max-w-xs">
            <p className="text-lg font-bold">Lisa Oktarani - RA Lasminingrat</p>
            <p className="mt-2 text-sm text-muted-foreground">
              Ruang aman dan anonim bagi perempuan Indonesia untuk memahami hak dan menemukan bantuan.
            </p>
          </div>
        ...
        <div className="mt-10 flex flex-col gap-2 border-t border-white/10 pt-6 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <p>© 2026 Lisa Oktarani - RA Lasminingrat. All rights reserved.</p>
