        ...
        <div className="mx-auto max-w-6xl px-6 py-28 md:py-36">
          <div className="animate-fade-up mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-gradient text-4xl font-bold tracking-tight md:text-6xl">
              Pahami Hakmu, Temukan Amanmu!
            </h1>

            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Svarati adalah ruang pribadi yang dapat digunakan secara anonim bagi perempuan Indonesia, terutama korban atau penyintas kekerasan seksual, untuk memahami hak-haknya, menemukan bantuan, dan melangkah menuju pemulihan.
            </p>
